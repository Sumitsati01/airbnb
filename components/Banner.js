...
function Banner() {
  return (
    <div className='relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px]'>
      ...
      />
      <div className='absolute  top-1/2 w-full text-center font-extrabold'>
        <p className='sm:text-lg'>Not Sure Where to go ?</p>
        ...
        transition duration-150'>Click Here!</button>
      </div>
    </div>
  )
}
